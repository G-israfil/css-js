...
function tokyo_tm_modalbox() {
    "use strict";
    jQuery('.grax_tm_all_wrap').prepend('<div class="tokyo_tm_modalbox"><div class="box_inner"><div class="close"><a href="#"><i class="icon-cancel"></i></a></div><div class="description_wrap"></div></div></div>');
}

function tokyo_tm_modalbox_portfolio() {
    "use strict";
    var modalBox = jQuery('.tokyo_tm_modalbox');
    var button = jQuery('.grax_tm_full_link.popup_info');
	console.log('israfil gzdl');
    ...
    button.on('click', function(event) {
        ...
        var image = parent.find('.list_inner').data('image');
        var details = parent.find('.details_all_wrap').html();
        var title = parent.find('.list_inner').data('title');
        var category = parent.find('.list_inner').data('category');
        ...
        modalBox.addClass('opened').show(); // Ensure the modal is shown
        modalBox.find('.description_wrap').html(details);
        modalBox.find('.description_wrap').prepend('<div class="top_image"><img src="' + image + '" alt="" /><div class="main" data-img-url="' + image + '"></div></div>');
        modalBox.find('.description_wrap').prepend('<div class="portfolio_main_title"><h3>' + title + '</h3><span>' + category + '</span></div>');

        // Optionally call this function if you have additional image-related logic
        // tokyo_tm_data_images();
    ...
    jQuery('.close-modal').on('click', function() {
        modalBox.removeClass('opened').hide(); // Ensure the modal is hidden
    });
}
